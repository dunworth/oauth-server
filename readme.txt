...
Import oas.zip project to mule.

Directions for testing App are here:

https://developer.mulesoft.com/docs/display/current/Building+an+External+OAuth+2.0+Provider+Application
